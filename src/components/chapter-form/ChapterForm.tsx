...
const ChapterForm = ({ resourceId, formState }: ChapterFormProps) => {
    ...
    return (
        <div className="form-container">
            <div className="form-header">
                <h1 className='form-header__title'>{formState === FormState.ADD ? "Add" : null} Chapter</h1>
            </div>
