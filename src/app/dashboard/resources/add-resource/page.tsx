...
const Page = () => {
    ...
    return (<div className={styles["form-container"]}>
        ...
        <div className={styles['form-inner-content']}>
            <Form className='form-dashboard' action="/dashboard/resources" onSubmit={onSubmit}>
                ...
                <div className={`${styles["form-field-wrapper"]} ${styles["centered-fields"]}`}>
                    ...
                    <select className={`${styles["form-field"]}`} id='form-resource__category' name="categoryId" onChange={handleChange}>
                ...
                <div className={`${styles["form-field-wrapper"]} ${styles["centered-fields"]}`}>
                    <button disabled={buttonDisabled} className={`${styles["form-field"]}`} type='submit'>Save</button>
                </div>
            </Form>
        </div>
    </div>)
